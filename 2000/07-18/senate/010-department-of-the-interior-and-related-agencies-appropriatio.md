---
granule: CREC-2000-07-18-pt1-PgS7085
date: 2000-07-18
edition: CREC
section: SENATE
page: S7085
citation: 146 Cong. Rec. S7085
---

# DEPARTMENT OF THE INTERIOR AND RELATED AGENCIES APPROPRIATIONS ACT, 2001--Resumed

**Speaking:** Reed, Jack (R000122) [D-RI], Gorton, Slade (G000333) [R-WA], Reid, Harry (R000146) [D-NV], Bryan, Richard H. (B000993) [D-NV], Smith, Gordon H. (S001142) [R-OR], Burns, Conrad R. (B001126) [R-MT], Nickles, Don (N000102) [R-OK], Craig, Larry E. (C000858) [R-ID], Durbin, Richard J. (D000563) [D-IL], Bingaman, Jeff (B000468) [D-NM], Campbell, Ben Nighthorse (C000077) [R-CO], Bennett, Robert F. (B000382) [R-UT], Bond, Christopher S. (B000611) [R-MO], Lincoln, Blanche L. (L000035) [D-AR], Roberts, Pat (R000307) [R-KS], Boxer, Barbara (B000711) [D-CA], Byrd, Robert C. (B001210) [D-WV], Stevens, Ted (S000888) [R-AK], Murkowski, Frank H. (M001085) [R-AK], Levin, Carl (L000261) [D-MI], Cochran, Thad (C000567) [R-MS], Inouye, Daniel K. (I000025) [D-HI], Allard, Wayne (A000109) [R-CO], Fitzgerald, Peter (F000442) [R-IL], Kerry, John F. (K000148) [D-MA], Chafee, Lincoln (C001040) [R-RI], Domenici, Pete V. (D000407) [R-NM], Collins, Susan M. (C001035) [R-ME], Johnson, Tim (J000177) [D-SD], McCain, John (M000303) [R-AZ], Dodd, Christopher J. (D000388) [D-CT], Feinstein, Dianne (F000062) [D-CA]

**Measures:** S.Res. 277, S. 1288, S. 1797, S. 2485, H.R. 2541, S. 2638, H.R. 4578
...
wintcruse.html)
     ...
     two-stroke engines, oxides of nitrogen (NO<INF>X</INF>) and 
     ozone are not pollutants of concern with respect to 
     snowmobile emissions.
     Explanation
       ● Two-cycle engines (including those used by 
     snowmobiles) emit less NO<INF>X</INF> than four-stroke 
     engines (including those used by automobiles).
       The February 2000 NPS ARD report estimates that only 2% of 
     the NO<INF>X</INF> pollution in YNP comes from snowmobile 
     engines (with the remainder of the NO<INF>X</INF> pollution 
     coming from automobiles, busses, snow coaches, and 
     recreational vehicles). Although the NPS ARD report does not 
     compare the NO<INF>X</INF> emissions from an automobile to 
     the NO<INF>X</INF> emissions from a snowmobile, it does 
     ...
     emits 1.5 to 6.8 times as much NO<INF>X</INF> as one 
     snowmobile.
       Low NO<INF>X</INF> emissions from snowmobile engines are 
     ...
     formed via a photochemical reaction between NO<INF>X</INF> 
     and volatile organic compounds (VOCs are a specific class of 
     unburned hydrocarbons). While snowmobiles do emit a 
     significant amount of VOCs, NO<INF>X</INF> emissions from 
     snowmobiles are minimal (as explained previously).
       Even when NO<INF>X</INF> are present in significant amounts 
     ...
     NO<INF>X</INF> emissions from automobiles are 1.5 to 6.8 
     times greater than NO<INF>x</INF> emissions form snowmobiles.
