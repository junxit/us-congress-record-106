...
future, and how the parties differ on the early proposals for change 
they are advancing, things that we need to look at very closely to make 
certain that we have a strong social security program going forward.
...
the Members, it improves the return on that social security investment 
very, very significantly immediately.
...
that we will have in this upcoming election year. It is an absolutely 
vital program for Americans. It pays not just retirement, but survivors 
...
so that while preserving

[[Page 7080]]

the full benefit structure, Social Security is with us through the life 
span of the baby boomers.
