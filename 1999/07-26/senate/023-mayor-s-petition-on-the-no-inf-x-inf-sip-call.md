---
granule: CRECB-1999-pt12-Pg17643
date: 1999-07-26
edition: CRECB
section: SENATE
page: 17643
...
# MAYOR'S PETITION ON THE NO<INF>X</INF> SIP CALL

```
            MAYOR'S PETITION ON THE NO<INF>X</INF> SIP CALL

  Mr. VOINOVICH. Mr. President, last year, EPA finalized the 
NO<INF>X</INF> SIP call, forcing 22 states to submit plans to meet 
mandated reductions of nitrogen oxide (NO<INF>X</INF>) emissions. Our 
...
the NO<INF>X</INF> SIP call could affect electricity reliability in 
urban and rural areas. In essence our mayor's are saying that any new 
programs to control NO<INF>X</INF> emission must be weighed against 
potential economic adverse implications.
  Mr. President, the U.S. Court of Appeals issued a stay of EPA's 
NO<INF>X</INF> SIP call pending a decision on the lawsuit brought by 
states. Nonetheless, the Mayors' petition represents a commonsense plea 
to EPA that, should the agency move forward to implement NO<INF>X</INF> 
...
the Record, as follows:
              ...
              EPA Ozone Transport NO<INF>X</INF> SIP Call
     ...
     NO<INF>X</INF> rule. This is especially true for local areas 
