---
granule: CREC-1999-10-21-pt1-PgS13029
date: 1999-10-21
edition: CREC
section: SENATE
page: S13029
citation: 145 Cong. Rec. S13029
---
...
introduced S. 1755. The text of the bill follows:
     ...
     designated database provider, shall be provided in a format 
     approved by the American National Standards Institute's 
     Accredited Standards Committee X12, that, allowing for de 
     minimis deviations, designates for each street address in the 
     State, including to the extent practicable, any multiple

[[Page S13030]]

     postal street addresses applicable to one street location, 
     the appropriate jurisdictions, and the appropriate code for 
     each taxing jurisdiction, for each level of taxing 
     jurisdiction, identified by one nationwide standard numeric 
     code. The electronic database shall also provide the 
     ...
     jurisdiction. The nationwide standard numeric codes shall 
     contain the same number of numeric digits with each digit or 
