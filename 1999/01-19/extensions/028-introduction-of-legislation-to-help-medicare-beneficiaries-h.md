---
granule: CRECB-1999-pt1-Pg1188-3
date: 1999-01-19
edition: CRECB
section: EXTENSIONS
page: 1188
...
# INTRODUCTION OF LEGISLATION TO HELP MEDICARE BENEFICIARIES HURT BY Y2K COMPUTER DELAYS IN HOSPITAL OUTPATIENT DEPARTMENT PAYMENT REFORM
...
in promised savings can still be achieved.
     ...
     offsetting reduction in the Medicare payment since 
     coinsurance is subtracted out in order to determine the 
     Medicare payment. Furthermore, since the Medicare payment is 
     calculated as if coinsurance is 20% (rather than 18%), the 
     Medicare payment would go down by more than the increase in 
     the coinsurance payment (which is based on a lower 
     percentage).
