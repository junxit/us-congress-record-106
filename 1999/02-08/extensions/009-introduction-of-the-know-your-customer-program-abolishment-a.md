...
be required to (1) identify their customers, (2) determine the source 
of income of its customers, (3) determine the ``normal and expected'' 
transactions of each customer, (4) monitor each customer's account 
activity to insure it is compatible with historical patterns, and (5) 
