---
granule: CRECB-1999-pt1-Pg1413-3
date: 1999-01-27
edition: CRECB
section: SENATE
page: 1413
...
[[Page 1416]]
     ...
     CAA to the legislative branch, the Board will be better 
     situated to formulate recommendations about appropriate 
     changes in those different statutory schemes.'' <SUP>18</SUP> 
...
---------------------------------------------------------------------------
     ...
     legislative branch, but the

[[Page 1417]]

     Board may decide to do so in a subsequent biennial report 
     under section 102(b).
...
---------------------------------------------------------------------------
     ...
     the legislative branch,'' <SUP>37</SUP> the Board

[[Page 1418]]

     makes a number of recommendations respecting the application 
     of these currently inapplicable enforcement provisions.
---------------------------------------------------------------------------
...
---------------------------------------------------------------------------
     ...
     from the comparison between the CAA's remedial

[[Page 1419]]

     schemes and those authorities provided for the administration 
     and enforcement of the CAA laws in the private sector:
       4. Extend the benefits of the model alternative dispute 
           resolution system created by the CAA to the private and 
           the federal sectors
...
[[Page 1420]]
     ...
     mechanisms for monitoring compliance and detecting and 
     correcting violations, and (b) a fair and independent 
     mechanism for informally resolving or, if necessary, 
...
---------------------------------------------------------------------------
     ...
     regulations modeled on civil service law.<SUP>63</SUP>
---------------------------------------------------------------------------
     \63\ Id.
---------------------------------------------------------------------------
...
---------------------------------------------------------------------------
     ...
     these rights. <SUP>73</SUP> In defining the coverage 
...
[[Page 1421]]
     ...
     which the legislative history of the CAA portrays as the 
     intended workplace model for the legislative branch.
...
---------------------------------------------------------------------------
     ...
     approved by the House and Senate, those

[[Page 1422]]

     executive-branch agency regulations themselves are applied 
     under the CAA in most instances.<SUP>75</SUP> The regulatory 
     requirements made applicable by the CAA are therefore 
     established by regulatory agencies independent of the 
...
[[Page 1423]]
     ...
     where outside agencies now have little role in either 
     investigation and prosecution or in administrative 
...
[[Page 1424]]
     ...
     instrumentalities, should not impose confidentiality 
     requirements except to the same extent that confidentiality 
     is imposed in proceedings by the executive-branch agencies 
     implementing the CAA laws and to the extent necessary to 
     facilitate effective counseling and mediation under 
     Sec. Sec. 402 and 403 of the CAA.<SUP>81</SUP>
---------------------------------------------------------------------------
...
1 See, e.g., U.S. Dep't of Labor v. Cole Enterprises, 62 F.3d 775, 778
  ...
  Donovan v. Agnew, 712 F.2d 1509, 1511 (1st Cir. 198
...
4. Grant of investigatory powers. The OSHAct        Sec. 8(b); 29 U.S.C.
 empowers the Labor Secretary, in conducting an      Sec.  657(b).
 inspection or investigation, to compel the
 production of evidence under oath. The CAA
 neither references Sec.  8(b) nor sets forth
 similar provisions granting compulsory process in
 the context of inspections and investigations.
 (Sec.  405(f) of the CAA grants subpoena powers
 to hearing officers, but these CAA authorities do
 not grant subpoena powers for use in agency
...
[[Page 1433]]
     ...
     EEOC General Counsel brings such

[[Page 1434]]

     civil actions on behalf of the EEOC. Remedies. The agency may 
     request back wages, plus an equal amount in liquidated 
     damages on behalf of aggrieved persons, and may also seek an 
     injunction in federal district court restraining violations, 
     including an order to pay compensation due, plus 
     interest.<SUP>70</SUP>
     ...
     Administrator shall ``prescribe by regulation or order.'' 
     <SUP>101</SUP> The FMLA further provides that the Secretary 
     may not require an employer to submit to the Secretary any 
     books or records more than once in 12 months, unless the 
     Secretary has reasonable cause to believe there may be a 
     violation or is investigating an employee 
     ...
     <SUP>104</SUP> Directed investigations. The FLSA has no 
     ...
     Administrator can issue and enforce subpoenas, relying on the 
     authorities of the FTC Act. <SUP>108</SUP> Issuance. The 
     power of the Secretary and the Administrator to issue 
     subpoenas under the FLSA may not be delegated. <SUP>109</SUP> 
     Enforcement. The FLSA authorizes the Secretary and the 
     Administrator to invoke the aid of Federal courts to enforce 
...
The Kiess Act, 44 U.S.C.     The CAA would also preclude   provisions and OPM's        lieu of overtime pay, as
 ...
 to pay salaried employees    in lieu of FLSA overtime     authorities as apply in    
Private-sector employers
 compensatory time off for    pay                          the federal sector          are not covered by civil
 overtime work               DoL's regulatory             +Federal-sector employers    service provisions
GPO is also covered by        requirements would apply     cannot require employees    authorizing flexible
 civil service statutes       in lieu of OPM's, which      to receive comp time in     schedules in exception to
 authorizing credit hours     are more specific and        lieu of overtime pay, as    FLSA overtime pay
 and compressed work          tailored to the federal      GPO can do under the        requirements.\1\
 schedules in exception to    civil service                Kiess Act                  
Private-sector provisions
 FLSA overtime pay.                                                                    would apply DoL's
                                                                                       implementing regulations
                                                                                       in lieu of OPM's, which
...
A GPO employee alleging a    +Use of model ADR process    =GPO employees are covered  
Whereas GPO is now bound
 violation may complain to    under CAA is a               under the same statutory    by OPM's administrative
 OPM, either immediately or   prerequisite to proceeding   and regulatory provisions   decisions on individual
 after having first           with complaint               governing OPM's receipt     complaints, employers
 complained under GPO's      
The CAA provides             and resolution of           under private-sector
 administrative grievance     counseling, mediation, and   complaints as federal-      provisions are not bound
 process                      adjudication administered    sector employees            by DoL's administrative
GPO must provide any          by the OC, unlike                                        decisions on complaints
 information requested by     complaints now against                                   unless DoL sues and
 OPM, and is legally bound    GPO, decided by OPM                                      prevails in court.
 by OPM's administrative      without adjudication.
 decision                    -Under the CAA, information
Bargaining unit members       is developed only through
 must use negotiated          the parties' discovery;
 grievance procedures         OPM can currently request
                              necessary information from
                              GPO.
                             (The CAA should provide for
                              investigation and
...
GPO is subject to            
CAA substantive             =GPO is covered by          
For the private sector,
 substantive regulations      regulations are adopted      generally the same OPM      regulations are
 promulgated by OPM           for the legislative branch   regulations implementing    promulgated by DoL;
 implementing the FLSA        by the OC Board, subject     the FLSA as apply in the    whereas GPO is now
 Government-wide              to House and Senate          federal sector              subject to regulations
                              approval; GPO is subject    +However, federal-sector     promulgated by OPM.
                              to regulations issued        employees are also
...
Sec.  19(a)(1) of the        +The CAA generally makes     +E.O. 12196 requires        +The OSHAct requires
...
No agency outside of GPO     +The OC would adopt          +E.O. 12196 requires each   +The OSHAct authorizes DoL
 has authority to             exceptions and variances,    covered agency to           to adopt exceptions and
