---
granule: CREC-1999-10-29-pt1-PgS13529
date: 1999-10-29
edition: CREC
section: SENATE
page: S13529
citation: 145 Cong. Rec. S13529
---

# AFRICAN GROWTH AND OPPORTUNITY ACT--Continued

**Speaking:** Lott, Trent (L000447) [R-MS], Daschle, Thomas A. (D000064) [D-SD], Murkowski, Frank H. (M001085) [R-AK]
...
that. We will talk to you about that, exactly when

[[Page S13530]]

we need to do it, and we can go to bankruptcy before we go out. My 
intent would be to go to it next, after consultation with both sides.
...
if we can at least do that and get it cleared. But we do have a problem 
with objections. We can see if we can get it agreed to, and we can try 
to get it agreed to, if we can get something worked out that we can 
offer. Then if it is objected to, we just have to deal with that.
